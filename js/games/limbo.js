...
window.PFGames.verifyLimbo = function (ctx) {
  var el = ctx.el;
  var H = ctx.H;
  ...
  var randomR = parts.r;
  var randomInt = Math.floor(randomR * range);
  var limboRaw = (range / (randomInt + 1)) * (1 - houseEdge);
  var limboDisplay = Math.floor(limboRaw * 100) / 100;
